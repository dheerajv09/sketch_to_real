...
class _HomeState extends State<Home> {
  ...
  void fetchResponse(File imageFile) async {
    ...
    final imageUploadRequest = http.MultipartRequest(
        'POST',
        Uri.parse(
            'http://192.168.1.8:5000/generate')); //PUT YOUR OWN IP HERE, it may vary depending on your computer
  ...
  void displayResponseImage(String fileName) async {
    setState(() {
      String outputFile = 'http://192.168.1.8:5000/download/' + fileName;
                          ...
                          children: <Widget>[
                            IconButton(
                              ...
                              onPressed: () async {
                                ...
                                /*print('-----');
                                final response =
                                    await http.get('http://192.168.1.8:5000/');
                                print('--//--');
                                final decoded = json
                                    .decode(
                                ...
                                print(decoded[
                                    'greetings']); */ //changing the state of our lwidget on data update
                              },
                            ),
                            IconButton(
                              icon: Icon(
